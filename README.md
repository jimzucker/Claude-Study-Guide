...
3. **Introduction to Claude Cowork:** Delegate multi-step work to Claude in Cowork: set up workspaces, give context, run task loops, and use plugins for research, documents, and browser tasks. 
14 lessons · 1 quiz 
2.5 hr
